...
You're comfortable with computers but have never written a line of code. Maybe you're a student curious about programming, someone exploring a career change, or just someone who wants to understand how software works by building something real.

**No prior experience required.** Seriously.
...
That's it. Claude Code takes it from here.
...
| `ARCHITECTURE.md` | How your project is designed. Grows as you build. |
| `setup.sh` / `setup.ps1` | Scripts that verify your environment is ready. |

## Requirements

- A computer made in the last ~8 years (Windows, Mac, or Linux)
- An internet connection
- A [GitHub account](https://github.com/signup) (free)
- A [Claude Pro subscription](https://claude.ai) (required for Claude Code)

## Getting Help

Stuck on something? Here's what to do:

1. **Ask Claude Code.** Type your question in plain English. It's literally designed for this.
2. **Re-read the wiki page** for the step you're on. The answer might be in a detail you skimmed.
3. **Check the Glossary.** If a term is confusing, it might already be defined there.
4. **Open an issue** on this repo if you think something in the guide is wrong or unclear.
